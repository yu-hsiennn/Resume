...
%---------------------------------------------------------
  \cventry
    ...
    {2023 FunAI Winter Camp} % Organization
    {Tainan, Taiwan} % Location
    {Feb. 2023} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Assistant constructing the execution environment for camp.}
        \item {Preparing simple instructional materials.}
        \item {Assisting students in problem-solving.}
      \end{cvitems}
    }
